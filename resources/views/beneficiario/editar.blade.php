...
<div class="formulario" style="margin-left: 25%;">  
  <form method="post" action="/perfil/{{Auth::id()}}/editar"> 
    @csrf
     <div style="margin-right: -10%:margin-top:2%">Género</div>
   ...
   <select id="genero" type="text"  autocomplete="off" class="form-control{{ $errors->has('genero') ? ' is-invalid' : '' }}" name="genero" value="{{ old('genero') }}" style="text-align: center;width: 50%" required autofocus >
                        ...
                        <div style="margin-right: -10%;margin-top:2%">RFC</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Estado Civil</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Nacionalidad</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Entidad</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Fecha de nacimiento</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Celular</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Correo</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Fecha de inscripción al programa</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Tipo de perfil</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Área</div>
 ...
 <div style="margin-right: -10%;margin-top:2%">Disciplina</div>
...
<div style="margin-right: -10%;margin-top:2%">Nombramiento</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Tipo de nombramiento</div>
                    ...
                    <div style="margin-right: -10%;margin-top:2%">Dedicación</div>
                    ...
                    <div style="margin-right: -10%;margin-top:2%">Unidad</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Fecha de contrato</div>
                         ...
                         <div style="margin-right: -10%;margin-top:2%">Nivel de estudios</div>
                        ...
                        <div style="margin-right: -10%;margin-top:2%">Siglas</div>
...
<div style="margin-right: -10%;margin-top:2%">Estudios</div>
...
<div style="margin-right: -10%;margin-top:2%">País</div>
...
<div style="margin-right: -10%;margin-top:2%">Institucion otorgante</div>
...
<div style="margin-right: -10%;margin-top:2%">Fecha de titulación</div>
